...
<body style="background-color: black;">
    ...
    <div class="bgimgulti">
        <div class="py-2 h1sea">
            <h1 class="display-5 fw-bold">BEN 10 ULTIMATE ALIEN</h1>
        </div>
    ...
    <li><a class="dropdown-item" href="ultimate_alien.php?sid=1&cid=<?php echo $cid; ?>" style="text-decoration: none;">season 1</a></li>
    <li><a class="dropdown-item" href="ultimate_alien.php?sid=2&cid=<?php echo $cid; ?>" style="text-decoration: none;">season 2</a></li>
    <li><a class="dropdown-item" href="ultimate_alien.php?sid=3&cid=<?php echo $cid; ?>" style="text-decoration: none;">season 3</a></li>
        ...
        <div class="para1">
            <p class="fw-bold">A year after Ben Tennyson defeated Vilgax, he's known the world over as a hero -- to kids, anyway. Adults are somewhat more suspicious. Armed with his mysterious new "Ultimatrix," which can transform his aliens into their "ultimate" forms, Ben and his pals Gwen and Kevin are ready for more action.</p>
            <span class="text-decoration-underline">IMDB 7.7</span>
            <span class="text-decoration-underline">2010</span>
            <span class="text-decoration-underline">20 episodes</span>
        </div>
