...
<body style="background-color: black;">
    ...
    <div class="bgimgalien">
        <div class="py-2 h1sea">
            <h1 class="display-5 fw-bold">BEN 10 ALIEN FORCE</h1>
        </div>
    ...
    <li><a class="dropdown-item" href="alien_force.php?sid=1&cid=<?php echo $cid; ?>" style="text-decoration: none;">season 1</a></li>
    <li><a class="dropdown-item" href="alien_force.php?sid=2&cid=<?php echo $cid; ?>" style="text-decoration: none;">season 2</a></li>
    <li><a class="dropdown-item" href="alien_force.php?sid=3&cid=<?php echo $cid; ?>" style="text-decoration: none;">season 3</a></li>
        ...
        <div class="para1">
            <p class="fw-bold">Ben Tennyson is now 15 and becoming a leader wearing his powerful Omnitrix again.
                 Grandpa Max is missing and Ben needs the help of Gwen and Kevin to find him. Ben has 10 new aliens
                  including Swampfire, Goop and Jetray
                 to fight against Highbreed and stop him from making humans extinct and destroying Earth.</p>
            <span class="text-decoration-underline">IMDB 7.4</span>
            <span class="text-decoration-underline">2008</span>
            <span class="text-decoration-underline">13 episodes</span>
        </div>
        <a href="video.php?id=53&sid=<?php echo $sid; ?>&cid=<?php echo $cid; ?>" style="text-decoration: none; color:inherit;"> <button type="button"
